    ...
    public static void Run()
    {
        ...
        try
        {
            ...
            if (!context.Contains("session-1", StringComparison.Ordinal) || !context.Contains("SMSR", StringComparison.Ordinal)
                ...
                || !context.Contains("two or more independently trackable child tasks", StringComparison.Ordinal)
                || !context.Contains("Never leave a broad parent as a leaf", StringComparison.Ordinal)
                || !context.Contains("Do not create a nested graph from duration alone", StringComparison.Ordinal)
