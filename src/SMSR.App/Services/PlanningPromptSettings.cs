...
public static class PlanningPromptSettings
{
    ...
    public const string Default = """
        ...
        서로 독립적인 작업은 병렬 진행 가능 여부를 표시하세요. 같은 원인으로 3회 실패하면 재시도를 중단하고 실패 원인, 시도 내역과 필요한 결정을 보고하세요. 모든 필수 작업과 검증이 성공했을 때만 완료로 판정하세요. 계획 초안을 사용자에게 보여주고 수정 의견 또는 진행 승인을 받은 뒤 작업을 시작하세요. 사용자가 계획 검토 생략을 명시하면 바로 진행하세요. SMSR 그래프 기록은 사용자가 그래프, 흐름 또는 대시보드 추적을 명시적으로 요청한 작업에만 적용하세요.
        """;
