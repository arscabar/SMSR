...
internal static class DashboardStyles
{
    ...
    private const string Css = """
        *{box-sizing:border-box}
        ...
        .node-actions{margin-top:12px;padding-top:11px;border-top:1px solid var(--border)}.node-actions h4{margin:0 0 8px;font-size:11px;color:var(--muted)}.node-actions div{display:flex;flex-wrap:wrap;gap:7px}.node-actions button{padding:6px 9px;border:1px solid #438ddd;border-radius:7px;background:var(--active);color:var(--text);font-size:11px;font-weight:700;cursor:pointer}.node-actions button:disabled{opacity:.55;cursor:wait}.node-actions p{margin:7px 0 0;color:var(--muted);font-size:10px;line-height:1.4}
