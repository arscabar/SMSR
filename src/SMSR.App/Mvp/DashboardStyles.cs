...
internal static class DashboardStyles
{
    ...
    private const string Css = """
        *{box-sizing:border-box}
        ...
        .detail dd{margin:3px 0 0;white-space:pre-wrap;overflow-wrap:anywhere}.history-title{margin-top:20px}.history{padding-left:19px;color:var(--muted);font-size:12px}.history li{margin:7px 0}.activity li.running{color:var(--text)}.running-time{color:#62adff;font-weight:700}.empty{color:var(--muted);font-size:13px}
